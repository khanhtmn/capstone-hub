...
class User(db.Model):
    ...
    primary_major = db.Column(db.String())
    secondary_major = db.Column(db.String())
    primary_concentration = db.Column(db.String())
    secondary_concentration = db.Column(db.String())
    special_concentration = db.Column(db.String())
    minor = db.Column(db.String())
    minor_concentration = db.Column(db.String())
